...
impl Buffer {
    ...
    #[inline]
    pub fn try_with_capacity(capacity: usize) -> std::io::Result<Self> {
    ...
    pub fn read_more(&mut self, mut reader: impl Read) -> std::io::Result<usize> {
